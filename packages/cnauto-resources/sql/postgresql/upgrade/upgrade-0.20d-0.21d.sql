-- /packages/cnauto-resources/sql/postgresql/upgrade/upgrade-0.20d-0.21d.sql

SELECT acs_log__debug ('/packages/cnauto-resources/sql/postgresql/upgrade/upgrade-0.20d-0.21d.sql','');



ALTER TABLE cn_vehicles DROP COLUMN model;
ALTER TABLE cn_vehicles ADD COLUMN  model_id integer;
ALTER TABLE cn_vehicles ADD CONSTRAINT cn_vehicles_model_id_fk FOREIGN KEY (model_id) REFERENCES cn_categories (category_id);
