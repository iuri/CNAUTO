...
set title "#cnauto-assurance.Import_CSV_file#"
set context $title


ad_form -html { enctype multipart/form-data } -name import_file -form {
    {input_file:file {label "#cnauto-assurance.Input_file#"} {html "size 30"}}
} -on_submit {
    ...
    if {[string equal $mime_type "application/vnd.ms-excel"]} {
	cn_assurance::import_csv_file -input_file $tmp_file
    } else {
