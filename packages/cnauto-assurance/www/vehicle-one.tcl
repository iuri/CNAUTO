...
set person_one_url [export_vars -base "person-ae" {return_url}] 



ad_form -name vehicle_one -mode display -form {
    {inform1:text(inform)
	...
	{help_text "<a href=\"${person_one_url}\">#cnauto-assurance.Client_info#</a>"}
    }
    {notes:text(textarea)
