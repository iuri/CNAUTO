	...
	<div id="footer">
		...
		<div id="box-right">
			<ul id="banner-fixo">
				...
				<li><a onclick="window.open(this.href); return false" href="http://www.seppir.gov.br"><img style="padding-top: 4px;" src="http://www.mda.gov.br/portal/arquivos/view/banners-principais-temporarios/selo_afro_branco.gif" alt="CGU"/></a> </li>
	...
	<if @subsite_admin_p@>
		<ul>
			<multiple name="applications">
					...
					<if @applications.name@ eq "noticias">
					<a href="@subsite_url@@applications.name@/item-create?return_url=@return_url@">#news.Add_news#</a> | <a href="@subsite_url@@applications.name@/admin/items-order">#news.Sort_news#</a>
