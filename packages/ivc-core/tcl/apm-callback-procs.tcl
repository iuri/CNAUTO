# /packages/theme-ivc/tcl/apm-callback-procs.tcl
ad_library {
    Installation procs to support theme-ivc pkg
...
ad_proc -private ivc::after_instantiate {
    {-package_id}
} {
...
ad_proc -private ivc::before_unmount {
    {-package_id}
} {
