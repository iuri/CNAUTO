ad_library {
    ...
    @cvs-id $Id: bounce-procs.tcl,v 1.8.4.1 2010/05/23 14:02:58 gustafn Exp $
...
#---------------------------------------
ad_proc -public acs_mail_lite::bouncing_email_p {
    -email:required
} {
...
#---------------------------------------
ad_proc -public acs_mail_lite::parse_bounce_address {
...
#---------------------------------------
ad_proc -public acs_mail_lite::scan_replies {} {
...
ad_proc -public acs_mail_lite::record_bounce {
    {-user_id ""}
    {-email ""}
} { 
