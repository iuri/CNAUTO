...
#---------------------------------------
ad_proc -public acs_mail_lite::address_domain {} {
...
#---------------------------------------
ad_proc -private acs_mail_lite::load_mails {
    -queue_dir:required
} {
...
#---------------------------------------
ad_proc -private acs_mail_lite::parse_email {
    -file:required
    -array:required
} {
...
ad_proc -public acs_mail_lite::autoreply_p {
    {-subject ""}
    {-from ""}
} {
