...
function FillFieldsOnChange(i) {
    ...
    var partsTotalCost = parseFloat(partsTotalCostObj.value, 4);
    ...
    var assuranceTotalCost = parseFloat(assuranceTotalCostObj.value, 4);
    ...
    var thirdTotalCost = parseFloat(thirdTotalCostObj.value, 4);
	...
	var partCost = parseFloat(partCostObj.value, 4);
	...
	var partQuantity = parseFloat(partQuantityObj.value, 4);
	...
	var thirdCost = parseFloat(thirdCostObj.value, 4);
