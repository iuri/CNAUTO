  ...
  <tr>
    <td width="45%" align="left" valign="top">
      <table cellpadding="0" cellspacing="0" border="0">
        <tr>
	  <td width="45%" align="left" valign="top">
	    <h1><u>#cnauto-import.CNIMP# @cnimp_number@</u></h1>
	...
	<tr>
	  ...
	  <td>
 	   ...
 	   <td>&nbsp;</td>
	   <td>&nbsp;</td>
	   <td align="right"><a href="order-ae?order_id=@order_id@&step=1">#cnauto-import.Edit#</a></td>
	 </tr>
         <tr>
	 ...
	 <tr>
	   ...
	   <td width="45%" align="left" valign="top">&nbsp;</td>
	   <td width="10%" align="left" valign="top">&nbsp;</td>
	   <td width="45%" align="right"><a href="order-ae?order_id=@order_id@&step=2">#cnauto-import.Edit#</a></td>
	 </tr>
	 <tr>
	   <td>&nbsp;</td>
	   <td>&nbsp;</td>
	...
	<tr>
	  <td width="45%" align="left" valign="top">&nbsp;</td>
 	  <td width="10%" align="left" valign="top">&nbsp;</td>
    	  <td width="45%" align="right" valign="top"><a href="order-ae?order_id=@order_id@&step=3">#cnauto-import.Edit#</a></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
        ...
        <tr>
	  <td width="45%" align="left" valign="top"><h1><u>#cnauto-import.Modal#</h1></u><br>@incoterm_id@</td>
 	  <td width="10%" align="left" valign="top">&nbsp;</td>
	...
	<tr>
      ...
      <table>
        ...
        <tr>
	 <td><div style="float:right;"><a href="order-ae?order_id=@order_id@&step=4">#cnauto-import.Edit#</a></div></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	</tr>
