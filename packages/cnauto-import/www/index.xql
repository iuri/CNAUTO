...
<queryset>
  ...
  <fullquery name="select_orders">
    <querytext> 
      SELECT DISTINCT cio.order_id, cio.parent_id, cio.cnimp_number, cp.pretty_name AS provider_pretty, cio.cnimp_date, cio.di_status, cio.order_cost, cio.transport_type, cio.li_need_p 
