...
db_1row select_order_info {
    SELECT cio.parent_id, cio.cnimp_number, cio.provider_id, cp.pretty_name AS provider, cio.cnimp_date, cio.approval_date, cio.li_need_p,payment_date, cio.manufactured_date, cio.departure_date, cio.awb_bl_number, cio.arrival_date, cio.order_quantity, cio.numerary_date, cio.di_date, cio.di_status, cio.di_number, cio.nf_date, cio.delivery_date, cio.incoterm_id, cii.pretty_name AS incoterm_pretty, cio.transport_type, cio.order_cost, cio.exchange_rate_type, cio.lc_number, cio.start_date
