-- /packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.12d-0.13d.sql

SELECT acs_log__debug (' /packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.12d-0.13d.sql','');
...
ALTER TABLE cn_import_orders ADD COLUMN order_quantity integer;
ALTER TABLE cn_import_orders ADD COLUMN di_number varchar;
