-- /packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.5d-0.6d.sql

SELECT acs_log__debug ('/packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.5d-0.6d.sql','');
