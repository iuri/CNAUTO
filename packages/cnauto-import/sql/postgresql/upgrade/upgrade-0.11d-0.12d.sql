-- /packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.11d-0.12d.sql

SELECT acs_log__debug ('/packages/cnauto-import/sql/postgresql/upgrade/upgrade-0.11d-0.12d.sql','');
