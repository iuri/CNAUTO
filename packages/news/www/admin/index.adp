...
<ul>
  ...
  <li><a href="items-order">#news.Order#</a>
  ...
  #rss-support.Create_feed#</a>] </li>  </else> -->
</ul>
    ...
    <form method=post action=process>
      <table border=0 cellspacing=5 cellpadding=5>
        ...
        <tr class="even">
          ...
          <td class="adminLink"><a href=@news_url@item?item_id=@news_items.item_id@>@news_items.publish_title@</a></td>
